      ...
      <section className="home-hero">
        <div className="home-main">
          <div className="home-video">
            <img
              src="/playground_assets/chili%20beans%20-%20playtime%20with%20my%20paw%20friends-1500h.jpg"
              alt="image"
          ...
          <div className="home-content">
            <header data-thq="thq-navbar" className="home-navbar">
              <img
                alt="logo"
                src="/playground_assets/chili%20beans%20logo-1500w.png"
                className="home-logo"
              />
            ...
            <div className="home-center">
              <div className="home-heading">
                <h1 className="home-header">
                  Chili Beans Professional Dog Walking
                </h1>
                <p className="home-caption">
                  Experience Top Dog Walking &amp; Pet Care in Inner West Sydney
                </p>
              </div>
      ...
      <section id="tours" className="home-quick-view">
          ...
          <div className="home-heading01">
            <h2 className="home-header01">
              <span className="home-text07">
                Chili Beans is your destination for exceptional dog walker
                Sydney services and pet care in Inner West Sydney. Our team is
        ...
        <div className="home-pagination">
          <button className="home-previous button-option button">
            ...
            <span className="home-text16">Previous</span>
          </button>
          <div className="home-pages">
            <div className="home-primary">
              ...
              <div className="page">
                <span className="home-text18">2</span>
              </div>
            ...
            />
            <div className="page">
              <span className="home-text20">12</span>
            </div>
          </div>
          <button className="home-next button-option button">
            <span className="home-text21">Next</span>
        ...
        <div className="home-highlight">
          <div className="home-content03">
            ...
            <button className="button-arrow button">
              <span className="home-text24">Read more</span>
